...
export default async function TopCard() {
  ...
  // Jika belum login, tampilkan pesan / fallback
  if (!user) {
    return (
      <p className="text-center text-sm py-4">Silakan login terlebih dahulu</p>
    );
  }
  ...
  return (
    <div className="w-[98%] max-w-2xl mx-auto bg-gray-50 rounded-sm shadow-lg py-4 px-2">
      <div className="grid grid-cols-4 gap-2">
        ...
        >
          <Wallet className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-800" />
          <p className="text-gray-600 text-[10px] sm:text-xs font-bold text-center mt-1">
            Saldo: <strong>{saldo.toLocaleString("id-ID")}</strong>
          </p>
        </Link>
        ...
        <div className="flex flex-col items-center justify-center cursor-pointer active:scale-95 transition-transform border-r-2 border-gray-200">
          <TicketPercent className="w-6 h-6 sm:w-8 sm:h-8 text-green-800" />
          <p className="text-gray-600 text-[10px] sm:text-xs font-bold text-center mt-1">
        ...
        <div className="flex flex-col items-center justify-center cursor-pointer active:scale-95 transition-transform border-r-2 border-gray-200">
          ...
          <p className="text-gray-600 text-[10px] sm:text-xs text-center font-bold mt-1">
        ...
        <div className="flex flex-col items-center justify-center cursor-pointer active:scale-95 transition-transform">
          <ScanLine className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-800" />
          <p className="text-gray-600 text-[10px] sm:text-xs font-bold text-center mt-1">
            Scan QR
          </p>
        </div>
